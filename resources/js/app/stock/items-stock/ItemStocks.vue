            ...
            <v-client-table v-model="items_in_stock" :columns="columns" :options="options">
              ...
              <div slot="action" slot-scope="props">
                <div v-if="props.row.is_warehouse_transfered === 0">
                  ...
                  <a v-if="checkPermission(['manage item stocks', 'delete item stocks']) && props.row.reserved_for_supply == 0 && props.row.in_transit == 0 && props.row.supplied == 0" class="btn btn-danger" @click="confirmDelete(props.index, props)"><i class="fa fa-trash" /> </a>
